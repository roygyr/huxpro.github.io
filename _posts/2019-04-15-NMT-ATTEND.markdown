...
![encoder过程](https://github.com/roygyr/roygyr.github.io/blob/master/img/encoder过程.png)
...
![主成分](https://github.com/roygyr/roygyr.github.io/blob/master/img/pca.png)
...
![decoder过程](https://github.com/roygyr/roygyr.github.io/blob/master/img/decoder%E8%BF%87%E7%A8%8B.png)


#### 综合模型
一个完整的Encoder-Decoder模型就是讲上述的两个过程相结合，结构如下：

![完整模型](https://github.com/roygyr/roygyr.github.io/blob/master/img/encoder-decoder.png)
